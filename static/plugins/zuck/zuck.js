    ...
    d = function (t, e) {
     var d = this,
      ...
      m = function (t, e) {
       ...
       try {
        ...
        console.warn("Fullscreen access denied");
       }
      },
      v = function (t, e, n, i) {
       var o = e > 0 ? 1 : -1,
        r = (Math.abs(e) / a("#moment-modal").offsetWidth) * 90 * o;
       if (u("cubeEffect")) {
        var s = 0 === r ? "scale(0.95)" : "scale(0.930,0.930)";
        if ((c(a("#moment-modal-content").style, "Transform", s), r < -90 || r > 90)) return !1;
       }
     ...
     var p = function (t) {
      ...
      g = {
       ...
       template: {
        ...
        viewerItem: function (t, e) {
         return '<div class="story-viewer">\n <div class="head">\n<div class="left">\n'.concat(u("backButton") ? '<a class="back hover:bg-gray-200 rounded-full p-2 transition -mr-1"><svg class="icon icon--20" role="img" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M9 6l-6 6 6 6"></path><path d="M21 12H4"></path><path stroke-linecap="round" d="M3 12h1"></path></svg></a>' : "", '\n\n<div class="item-preview">\n<img lazy="eager" src="').concat(i(t, "photo"), '" />\n</div>\n\n <div class="info">\n').concat(i(t, "name"), '\n</div>\n</div>\n\n <div class="right">\n<span class="loading"></span>\n<a class="close" tabIndex="2">&times;</a>\n</div>\n</div>\n\n<div class="slides-pointers">\n<div class="wrap"></div>\n</div>\n\n').concat(u("paginationArrows") ? '<div class="slides-pagination">\n<span class="previous">&lsaquo;</span>\n<span class="next">&rsaquo;</span>\n</div>' : "","\n</div>");
        },
        viewerItemPointer: function (t, e, n) {
         return '<span \nclass="'.concat(e === t ? "active" : "", " ").concat(!0 === i(n, "seen") ? "seen" : "", '"\ndata-index="').concat(t, '" data-item-id="').concat(i(n, "id"), '">\n<i style="animation-duration:').concat("" === i(n, "length") ? "3" : i(n, "length"), 's"></i>\n</span>');
        },
        viewerItemBody: function (t, e, n) {
         return '<div \nclass="item '.concat(!0 === i(n, "seen") ? "seen" : "", " ").concat(e === t ? "active" : "", '"\ndata-time="').concat(i(n, "time"), '" data-type="').concat(i(n, "type"), '" data-index="').concat(t, '" data-item-id="').concat(i(n, "id"), '">\n').concat("video" === i(n, "type") ? '<video class="media" muted webkit-playsinline playsinline preload="auto" src="'.concat(i(n, "src"), '" ').concat(i(n, "type"), '></video>\n<i class="tip muted">').concat(u("language", "unmute"), "</i>"): '<img loading="auto" class="media" src="'.concat(i(n, "src"), '" ').concat(i(n, "type"), " />\n"),"\n\n").concat(i(n, "link") ? '<a class="tip link" href="'.concat(i(n, "link"), '" rel="noopener" target="_blank">\n').concat(i(n, "linkText") && "" !== i(n, "linkText") ? i(n, "linkText") : u("language", "visitLink"), "\n</a>"): "","\n</div>");
        },
       },
       language: {
        ...
        time: { ago: "ago", hour: "hour ago", hours: "hours ago", minute: "minute ago", minutes: "minutes ago", fromnow: "from now", seconds: "seconds ago", yesterday: "yesterday", tomorrow: "tomorrow", days: "days ago" },
       },
      },
      h = (function () {
       var t,
       ...
       c ||
        d.hasModal ||
        ((d.hasModal = !0),
        ((c = document.createElement("div")).id = "moment-modal"),
        u("cubeEffect") && (c.className = "with-cube"),
        (c.innerHTML = '<div id="moment-modal-content"></div>'),
       ...
       var g = a("#moment-modal-content"),
        b = function (t) {
         var e = a("#moment-modal"),
          n = "",
          i = "",
          o = 0,
          c = a("#moment-modal-slider-".concat(y)),
          r = { previous: a("#moment-modal .story-viewer.previous"), next: a("#moment-modal .story-viewer.next"), viewing: a("#moment-modal .story-viewer.viewing") };
         ...
         u("cubeEffect") ? ("previous" === n ? (o = e.slideWidth) : "next" === n && (o = -1 * e.slideWidth)) : (o = -1 * f(r[n])[0]),
          ...
          setTimeout(function () {
           ...
           if ("" !== n && r[n] && "" !== i) {
            ...
            var o = a("#moment-modal .story-viewer.".concat(i));
            ...
            var m = d.internalData.currentStory,
             f = a('#moment-modal [data-story-id="'.concat(m, '"]'));
            if (f) {
             ...
             (d.data[m].currentItem = parseInt(f[0].getAttribute("data-index"), 10)),
              (f[0].innerHTML = '<i style="'.concat(p.style.cssText, '"></i>')),
              s(f[0].firstElementChild, function () {
               d.nextItem(!1);
              });
            }
            if ((v(c, "0", 0, null), f)) {
             var y = a('#moment-modal .story-viewer[data-story-id="'.concat(e, '"]'));
             x(y, [f[0], f[1]], !0);
            }
        ...
        I = function (t, e, n) {
         var c = a("#moment-modal-slider-".concat(y)),
          r = i(t, "items");
         ...
         var m = "",
          ...
          b = i(t, "currentItem") || 0;
         if (a('#moment-modal .story-viewer[data-story-id="'.concat(f, '"]'))) return !1;
         (g.className = "slides"),
          o(r, function (e, n) {
         ...
         (S.className = "story-viewer muted "
          ...
          o(S.querySelectorAll(".slides-pointers [data-index] > i"), function (t, e) {
           s(e, function () {
            d.nextItem(!1);
           });
          }),
       ...
       return {
        show: function (t, e) {
         var i = a("#moment-modal");
         u("callbacks", "onOpen")(t, function () {
          g.innerHTML = '<div id="moment-modal-slider-'.concat(y, '" class="slider"></div>');
          var e = d.data[t],
           o = e.currentItem || 0;
          !(function (t) {
           var e = a("#moment-modal"),
            ...
            m = null,
            p = function (t) {
             var n = a("#moment-modal .viewing");
             if ("A" !== t.target.nodeName) {
              var d = t.touches ? t.touches[0] : t,
               u = f(a("#moment-modal .story-viewer.viewing"));
              (e.slideWidth = a("#moment-modal .story-viewer").offsetWidth), (e.slideHeight = a("#moment-modal .story-viewer").offsetHeight), (o = { x: u[0], y: u[1] });
              var v = d.clientX,
               p = d.clientY;
            ...
            g = function t(f) {
             var p = a("#moment-modal .viewing"),
              g = c,
              h = c ? Date.now() - c.time : void 0,
              k = (Number(h) < 300 && Math.abs(s.x) > 25) || Math.abs(s.x) > e.slideWidth / 3,
              w = s.x < 0,
              L = a(w ? "#moment-modal .story-viewer.next" : "#moment-modal .story-viewer.previous"),
              E = (w && !L) || (!w && !L);
             if (c && !c.valid);
             else {
              s &&
          ...
          })(a("#moment-modal-slider-".concat(y))),
          ...
          if (u("openEffect")) {
           ...
           (i.style.marginLeft = "".concat(p[0] + l.offsetWidth / 2, "px")),
            ...
            (i.slideWidth = a("#moment-modal .story-viewer").offsetWidth),
            setTimeout(function () {
          ...
          } else (i.style.display = "block"), (i.slideWidth = a("#moment-modal .story-viewer").offsetWidth), s();
        ...
        next: function (t) {
         u("callbacks", "onEnd")(d.internalData.currentStory, function () {
          ...
          e && (e.classList.add("seen"), (d.data[t].seen = !0), (d.internalData.seenItems[t] = !0), E("seenItems", d.internalData.seenItems), w()), a("#moment-modal .story-viewer.next") ? (u("rtl") ? b(!1) : b(!0)) : h.close();
         });
        },
        close: function () {
         var t = a("#moment-modal");
      ...
      E = function (t, e) {
       try {
        if (u("localStorage")) {
         var a = "moment-".concat(y, "-").concat(t);
      ...
      I = function (t) {
       if (u("localStorage")) {
        var e = "moment-".concat(y, "-").concat(t);
     ...
     (d.data = u("stories") || {}),
      ...
      (d.navigateItem = d.nextItem = function (t, e) {
       var n = d.internalData.currentStory,
        ...
        c = a('#moment-modal .story-viewer[data-story-id="'.concat(n, '"]')),
        r = "previous" === t ? -1 : 1;
